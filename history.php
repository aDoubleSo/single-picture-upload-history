<html class=""><head></head><body data-original-padding-right="0" class="" style="padding-right: 0px;">
...
$(document).ready(function(){
 ...
 // Intialize gallery
 var gallery = $('.gallery a').simpleLightbox({ animationSlide: false, animationSpeed: 0, fadeSpeed: 0, scrollZoomFactor: 0.05, maxZoom: 4, disableRightClick: true});
